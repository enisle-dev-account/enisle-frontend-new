...
} from "../../../../surgery/schemas/surgery.schema";
  ...
  const handleCompleteSurgery = async () => {
    if (surgery) {
      const isConfirmed = await confirm({
        ...
        message:
          "Are you sure you want to mark this surgery as complete? This will save all current changes. Please note: you will not be able to edit these details once completed.",
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Enter procedure name (e.g., Hip Arthroplasty)"
                            {...field}
                ...
                {!showAllFields && (
                  <div className="flex gap-2 mt-4">
                    ...
                    <Button
                      type="button"
                      onClick={() => {
                        if (procedureValue && procedureValue.trim()) {
                          setShowAllFields(true);
                        }
                      }}
                      disabled={!procedureValue || !procedureValue.trim()}
                      className="rounded-full bg-primary hover:bg-primary/90"
                    >
                      Save
                    </Button>
                ...
                <>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      Please fill in patient's post surgery details
                    </p>
