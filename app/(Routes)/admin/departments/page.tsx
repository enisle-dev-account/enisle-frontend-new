...
import type {
  DepartmentEmployeeResponseData,
  ...
  return (
    <>
      ...
      <Tabs
        ...
        className="w-full"
      >
        <div className=" bg-background rounded-3xl mb-4 overflow-hidden">
              ...
              <div className="flex items-center gap-2 flex-1">
                <div className="relative flex-1 max-w-sm">
                  ...
                  <Input
                    placeholder={
                      viewMode === "staff"
                        ? "Search by last name, middle name or first name"
                        : "Search by email"
                    }
                    value={searchQuery}
        ...
        {/* Table Content */}
        <div className="flex-1 overflow-auto bg-background rounded-3xl">
          {/* Total Employees/Invitations Card */}
          <Card className="py-4 px-4 ring-0 mb-3 rounded-none">
            ...
            {viewMode === "staff" ? (
              <>
                {isLoading ? (
                  ...
                  <EmptyList
                    ...
                    description="There are no employees in this department."
                  />
                )}
              </>
            ) : (
              <>
                {invitationsLoading ? (
                  ...
                  invitationsData.results.length > 0 ? (
                  <InvitationsTable invitations={invitationsData.results} />
                ) : (
                  <EmptyList
                    title="No Invitations Yet"
                    description="There are no pending invitations for this department."
                  />
                )}
              </>
            )}
