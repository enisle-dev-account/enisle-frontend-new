...
export const useApiQuery = <T,>(key: string[], url: string, options?: UseQueryOptions<T>) =>
...
export const useCustomUrlApiMutation = <T,>(options?: UseMutationOptions<T, Error, any>) =>
  useMutation<T, Error, any>({
...
export const useAdminRegister = (options?: UseMutationOptions<any, Error, any>) => {
